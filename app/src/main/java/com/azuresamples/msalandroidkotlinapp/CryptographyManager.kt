...
interface CryptographyManager {
    ...
    fun getIsKeyStoreAvailable(keyName: String): Boolean

    fun removeKeyStore(keyName: String) : Boolean
...
private class CryptographyManagerImpl : CryptographyManager {
    ...
    override fun getIsKeyStoreAvailable(keyName: String): Boolean {
        val keyStore = KeyStore.getInstance(ANDROID_KEYSTORE)
        keyStore.load(null)
        return keyStore.isKeyEntry(keyName)
    }

    override fun removeKeyStore(keyName: String) : Boolean {
        val keyStore = KeyStore.getInstance(ANDROID_KEYSTORE)
        keyStore.load(null)
